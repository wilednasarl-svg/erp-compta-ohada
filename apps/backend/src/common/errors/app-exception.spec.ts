...
describe('HTTP status mapping', () => {
  it('matches the expected per-code statuses', () => {
    const expected: Record<keyof typeof ERROR_CODES, number> = {
      ...
      IMPORT_SESSION_CANNOT_DELETE: 409,
      ...
      TVA_ALREADY_CENTRALIZED: 409,
      TVA_DECLARATION_CENTRALIZED_CANNOT_CANCEL: 409,
      ...
      ASSET_UOP_UNITS_REQUIRED: 422,
      ASSET_UOP_UNITS_OVERFLOW: 422,
      ASSET_DEROGATORY_CONFIG_INVALID: 422,
      ...
      FISCAL_PARAMETER_NOT_FOUND: 404,
      FISCAL_PARAMETER_CODE_TAKEN: 409,
      FISCAL_DECLARATION_NOT_FOUND: 404,
      ...
      COLLECTIONS_NO_OVERDUE: 422,
      BANK_GENERATED_ENTRY_INVALID: 422,
    };
