...
/**
 * Expose la doctrine SYSCOHADA rattachée au module Dépréciations /
 * pertes de valeur (tests de valeur des actifs immobilisés et des stocks) :
...
@Controller('impairments/syscohada-guidance')
export class ImpairmentsSyscohadaGuidanceController {
  ...
  getGuidance(): SyscohadaModuleGuidance {
    return this.knowledge.getModuleGuidance('impairments');
  }
}
