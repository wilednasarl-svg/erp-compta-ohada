...
/**
 * Expose la doctrine SYSCOHADA rattachée au module Provisions pour
 * risques et charges : références du Guide d'application + contrôles
...
@Controller('provisions/syscohada-guidance')
export class ProvisionsSyscohadaGuidanceController {
  ...
  getGuidance(): SyscohadaModuleGuidance {
    return this.knowledge.getModuleGuidance('provisions');
  }
}
