...
/**
 * Expose la doctrine SYSCOHADA rattachée au module Effets de commerce :
 * références du Guide d'application + contrôles métier sourcés couvrant
 * les traites, l'escompte, l'encaissement et l'endossement (chaque
...
@Controller('bills-of-exchange/syscohada-guidance')
export class BillsOfExchangeSyscohadaGuidanceController {
  ...
  @ApiOperation({
    summary: 'Références et contrôles SYSCOHADA du module Effets de commerce (Tome 1).',
  })
  @ApiOkResponse({ description: 'Guidance doctrinale sourcée (références + contrôles cités).' })
  getGuidance(): SyscohadaModuleGuidance {
    return this.knowledge.getModuleGuidance('bills-of-exchange');
  }
}
