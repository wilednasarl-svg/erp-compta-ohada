...
const CATEGORIES: ReadonlyArray<BreakdownCategory> = [
  ...
  { key: 'EMPRUNTS_ETABL_CREDIT', label: 'Emprunts auprès des établissements de crédit (163, 164, 165)', prefixes: ['163', '164', '165'] },
  { key: 'AVANCES_ETAT', label: "Avances reçues de l'État et d'organismes publics (166, 167)", prefixes: ['166', '167'] },
  { key: 'AUTRES_EMPRUNTS', label: 'Autres emprunts et dettes assimilées (168, 169)', prefixes: ['168', '169'] },
  { key: 'CREDIT_BAIL', label: 'Dettes de crédit-bail et contrats assimilés (172, 173)', prefixes: ['172', '173'] },
  { key: 'DETTES_PARTICIPATIONS', label: 'Dettes liées à des participations (181, 182, 183, 184)', prefixes: ['181', '182', '183', '184'] },
];
