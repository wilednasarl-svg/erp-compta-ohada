...
const CATEGORIES: ReadonlyArray<BreakdownCategory> = [
  ...
  {
    key: 'RESERVES_STATUTAIRES',
    label: 'Réserves statutaires ou contractuelles (112)',
    prefixes: ['112'],
  },
  ...
  {
    key: 'REPORT_DEBITEUR',
    label: 'Report à nouveau débiteur (121, en déduction)',
    prefixes: ['121'],
  },
  {
    key: 'RESULTAT_NET',
    label: "Résultat net de l'exercice (130, 139)",
    prefixes: ['130', '131', '132', '133', '139'],
  },
];
