...
const CATEGORIES: ReadonlyArray<BreakdownCategory> = [
  { key: 'FRAIS_FIN', label: "Frais financiers et charges assimilées (671, 672, 673)", prefixes: ['671', '672', '673'] },
  { key: 'PERTES_CHANGE', label: 'Pertes de change (676)', prefixes: ['676'] },
  { key: 'AUTRES_CHARGES_FIN', label: 'Autres charges financières (677, 678, 679)', prefixes: ['677', '678', '679'] },
  { key: 'REV_FIN_PARTICIP', label: 'Revenus financiers et assimilés (771, 772, 773)', prefixes: ['771', '772', '773'] },
  { key: 'GAINS_CHANGE', label: 'Gains de change (776)', prefixes: ['776'] },
  { key: 'AUTRES_REV_FIN', label: 'Autres revenus financiers (777, 778)', prefixes: ['777', '778'] },
  { key: 'REPRISES_FIN', label: 'Reprises de provisions et dépréciations financières (797, 799)', prefixes: ['797', '799'] },
];
