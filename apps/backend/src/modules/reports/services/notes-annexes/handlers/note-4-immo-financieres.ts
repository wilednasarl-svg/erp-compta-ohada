...
const CATEGORIES: ReadonlyArray<BreakdownCategory> = [
  ...
  { key: 'CREANCES_RATTACHEES', label: 'Créances rattachées à des participations (271)', prefixes: ['271'] },
  { key: 'PRETS', label: 'Prêts (272, 273, 274)', prefixes: ['272', '273', '274'] },
  { key: 'DEPOTS_CAUTIONNEMENTS', label: 'Dépôts et cautionnements versés (275)', prefixes: ['275'] },
  { key: 'AUTRES', label: 'Autres immobilisations financières (276-279)', prefixes: ['276', '277', '278', '279'] },
];
